...
1. To study the equation $x_{n+1} = rx_n(1−x_n)$ and to see how it varies with r.\par
...
\begin{enumerate}
	\item 
	\item
	\item To calculate Feigenbaum constant. 
\end{enumerate}
...
\begin{figure}[h] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
	\includegraphics[width=\textwidth, height=10cm]{Figures/M 2a.png} % Example image
